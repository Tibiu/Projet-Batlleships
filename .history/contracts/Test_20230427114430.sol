...
contract Battleship {
    ...
    function addBoat(Direction direction, Coord memory topLeftCoord, Kind kind) public {
        ...
        require(game.state == GameState.SETUP);
        require(game.turn == address(0));
        require(game.boats[msg.sender][uint8(kind)].topLeftCoord.row == 0);
    ...
    for (uint8 i = 0; i < size; i++) {
        ...
        require(_grid[coord.row][coord.col] == 0 );
